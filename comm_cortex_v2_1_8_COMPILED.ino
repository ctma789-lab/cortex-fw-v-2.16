...
// ── USB CDC serial alias ──────────────────────────────────────
// On ESP32-S3 with "USB CDC On Boot: Enabled", the USB serial object
// is exposed as `Serial`. This firmware refers to it as `USBSerial`
// throughout, so alias it. If your core version already defines
// USBSerial as a distinct object, delete this line.
...
void setup() {
  ...
  delay(200);
  USBSerial.println("[BOOT] Communication Cortex v2.1.8");
